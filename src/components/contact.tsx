...
export const Contact = () => {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    // Contact form is under development — show a friendly message instead
    toast.info(
      "Thanks for visiting! The contact form is under development. Please connect with me via Instagram."
    );
